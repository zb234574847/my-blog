            ...
            <blockquote>
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p
                    class="text-item"
                  >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam auctor nec lacus ut tempor. Mauris.</p>
            ...
            <blockquote>
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p
                    class="text-item"
                  >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut rutrum elit in arcu blandit, eget pretium nisl accumsan.</p>
